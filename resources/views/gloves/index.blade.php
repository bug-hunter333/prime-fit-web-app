...
<div class="py-4">
    <p class="text-white font-righteous font-extrabold text-4xl m-6">Weightlifting Gloves</p>
                ...
                <div class="max-w-xs bg-black rounded-2xl shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    <div class="overflow-hidden rounded-t-2xl">
                        <img class="w-full h-48 object-cover transition-transform duration-300 hover:scale-110" 
                             src="{{ $glove->image_url ?? 'https://via.placeholder.com/300x200?text=No+Image' }}" 
                             alt="{{ $glove->name }}">
                    </div>
                    <div class="p-5 space-y-3">
                        <h5 class="text-lg font-bold text-green-500 truncate" title="{{ $glove->name }}">
                            {{ $glove->name }}
                        </h5>
                        ...
                        <div class="flex items-center justify-between">
                            <span class="text-xl font-bold text-green-400 transition-colors duration-200 group-hover:text-green-300">
                                ${{ number_format($glove->price ?? 0, 2) }}
                            </span>
                          <a href="{{ route('gloves.show', $glove->id) }}"
  ...
  <div class="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center md:items-start gap-8">
    ...
    <div class="md:w-1/2">
      <h2 class="text-2xl font-extrabold text-green-500 font-righteous mb-4">
        Prime Fit Weightlifting Gloves
      </h2>
      <p class="text-1xl text-white font-righteous font-semibold">
      PrimeFit Weightlifting Gloves: <br><br>
      The Ultimate Workout Companion offer superior comfort and support with padded palms and breathable material.
      Designed for enhanced grip and protection, they help reduce hand fatigue during intense lifting sessions, making them perfect for weightlifting, gym workouts, and other fitness activities.
      Whether you're performing bicep curls, shoulder presses, or deadlifts, weightlifting gloves provide an effective way to enhance your workout. Choose gloves with extra padding for added comfort or breathable materials for a lightweight, flexible option.
      </p>
      <br>
    </div>
    ...
    <div class="md:w-1/2">
      <div class="rounded-xl overflow-hidden shadow-lg">
       <img src="{{ asset('images/gloves.png') }}" alt="Prime Fit Dumbbell" class="w-full h-auto object-cover">
        ...
        <div class="max-w-4xl mx-auto px-4">
          ...
          <div class="mb-6">
            <div class="flex items-center justify-between cursor-pointer" onclick="toggleFAQ(1)">
              <h3 class="text-lg font-semibold text-gray-800">
                1. Why should I use weightlifting gloves?
              </h3>
              <span id="icon-1" class="text-xl text-gray-600">+</span>
            </div>
            <p id="answer-1" class="text-gray-700 mt-2 hidden">
             Adjustable barbells allow you to add or remove weight plates, offering flexibility for various exercises. 
             Fixed barbells have a set weight and are more straightforward for quick use.
            </p>
          </div>
          ...
          <div class="mb-6">
            <div class="flex items-center justify-between cursor-pointer" onclick="toggleFAQ(2)">
              <h3 class="text-lg font-semibold text-gray-800">
                2.How do I choose the right size for weightlifting gloves?
              </h3>
              <span id="icon-2" class="text-xl text-gray-600">+</span>
            </div>
            <p id="answer-2" class="text-gray-700 mt-2 hidden">
             To choose the right size, measure the circumference of your hand and refer to the brand's sizing chart. 
             Gloves should fit snugly without being too tight.
            </p>
          </div>
          ...
          <div class="mb-6">
            <div class="flex items-center justify-between cursor-pointer" onclick="toggleFAQ(3)">
              <h3 class="text-lg font-semibold text-gray-800">
              3. Do weightlifting gloves reduce wrist strain?
              </h3>
              <span id="icon-3" class="text-xl text-gray-600">+</span>
            </div>
            <p id="answer-3" class="text-gray-700 mt-2 hidden">
           Some weightlifting gloves come with wrist wraps or support to help reduce strain and stabilize your wrists during heavy lifts.
          </div>
        </div>
      </section>
