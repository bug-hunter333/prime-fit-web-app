            ...
            <tbody class="divide-y divide-gray-700">
                ...
                <tr class="hover:bg-gray-700 transition duration-200">
                    ...
                    <td class="p-4 text-center">
                        <a href="{{ route('dumbells.remove', $id) }}" class="inline-flex items-center bg-red-600 hover:bg-red-700 px-4 py-2 rounded-md shadow transition text-white text-sm font-medium">
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-lg px-6 py-5 text-right shadow-md">
            <p class="text-lg font-semibold mb-4">
                ...
                <span class="text-green-400">
                   ...
                   <a href="{{ route('dumbells.checkout') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2 rounded-md shadow-md transition inline-flex items-center">
