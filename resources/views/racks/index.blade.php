...
<div class="hidden md:block bg-black text-white p-4">
    <div class="flex justify-around text-white text-sm font-righteous font-bold max-w-7xl mx-auto">
        ...
        <a href="{{ route('racks.index') }}" class="text-green-500 transition duration-300 flex items-center gap-2">
...
<div class="py-4">
    <p class="text-white font-righteous font-extrabold text-4xl m-6">Rigs & Racks</p>
                ...
                <div class="max-w-xs bg-black rounded-2xl shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    <div class="overflow-hidden rounded-t-2xl">
                        <img class="w-full h-48 object-cover transition-transform duration-300 hover:scale-110" 
                             src="{{ $rack->image_url ?? 'https://via.placeholder.com/300x200?text=No+Image' }}" 
                             alt="{{ $rack->name }}">
                    </div>
                    <div class="p-5 space-y-3">
                        <h5 class="text-lg font-bold text-green-500 truncate" title="{{ $rack->name }}">
                            {{ $rack->name }}
                        </h5>
  ...
  <div class="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center md:items-start gap-8">
    ...
    <div class="md:w-1/2">
      <h2 class="text-2xl font-extrabold text-green-500 font-righteous mb-4">
        Prime Fit Rigs and Racks 
      </h2>
      <p class="text-1xl text-white font-righteous font-semibold">
      PrimeFit Weightlifting Rigs and Racks: <br><br>
      The Ultimate Workout Companion offer a comprehensive, versatile solution for all your fitness needs.
    Designed for strength training, they provide multiple stations for exercises like squats, pull-ups, deadlifts, and more. 
    Built with durability and stability in mind, these rigs and racks ensure safety and support during intense workouts. 
    Perfect for both home gyms and professional setups, they allow users to maximize their training potential in one compact, multifunctional unit.
      </p>
      <br>
    </div>
    ...
    <div class="md:w-1/2">
      <div class="rounded-xl overflow-hidden shadow-lg">
       <img src="{{ asset('images/rack.png') }}" alt="Prime Fit Dumbbell" class="w-full h-auto object-cover">
        ...
        <div class="max-w-4xl mx-auto px-4">
          ...
          <div class="mb-6">
            <div class="flex items-center justify-between cursor-pointer" onclick="toggleFAQ(1)">
              <h3 class="text-lg font-semibold text-gray-800">
                1.What exercises can I perform with PrimeFit Rigs & Racks?
              </h3>
              <span id="icon-1" class="text-xl text-gray-600">+</span>
            </div>
            <p id="answer-1" class="text-gray-700 mt-2 hidden">
             You can perform a variety of exercises, including squats, pull-ups, deadlifts, bench presses, 
             overhead presses, and more
            </p>
          </div>
          ...
          <div class="mb-6">
            <div class="flex items-center justify-between cursor-pointer" onclick="toggleFAQ(2)">
              <h3 class="text-lg font-semibold text-gray-800">
                2.How durable are PrimeFit Rigs & Racks?
              </h3>
              <span id="icon-2" class="text-xl text-gray-600">+</span>
            </div>
            <p id="answer-2" class="text-gray-700 mt-2 hidden">
             They are built with high-quality materials to ensure durability and long-lasting performance,
          ...
          <div class="mb-6">
            <div class="flex items-center justify-between cursor-pointer" onclick="toggleFAQ(3)">
              <h3 class="text-lg font-semibold text-gray-800">
              3. What is the weight capacity of PrimeFit Rigs & Racks?
              </h3>
              <span id="icon-3" class="text-xl text-gray-600">+</span>
            </div>
            <p id="answer-3" class="text-gray-700 mt-2 hidden">
                The weight capacity varies by model, but they are generally designed to handle heavy loads,
                 supporting users with various fitness levels.
