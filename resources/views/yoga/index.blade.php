...
<div class="py-4">
    <p class="text-white font-righteous font-extrabold text-4xl m-6">Yoga Mats</p>
                ...
                <div class="max-w-xs bg-black rounded-2xl shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    <div class="overflow-hidden rounded-t-2xl">
                        <img class="w-full h-48 object-cover transition-transform duration-300 hover:scale-110" 
                             src="{{ $yoga->image_url ?? 'https://via.placeholder.com/300x200?text=No+Image' }}" 
                             alt="{{ $yoga->name }}">
                    </div>
                    <div class="p-5 space-y-3">
                        <h5 class="text-lg font-bold text-green-500 truncate" title="{{ $yoga->name }}">
                            {{ $yoga->name }}
                        </h5>
                        ...
                        <div class="flex items-center justify-between">
                            <span class="text-xl font-bold text-green-400 transition-colors duration-200 group-hover:text-green-300">
                                ${{ number_format($yoga->price ?? 0, 2) }}
                            </span>
                          <a href="{{ route('yoga.show', $yoga->id) }}"
...
<div class="py-2">
  ...
  <div class="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center md:items-start gap-8">
    ...
    <div class="md:w-1/2">
      ...
      PrimeFit Yoga Mats: <br><br>
    The Ultimate Workout Companion offer superior comfort and stability with a non-slip surface, making them perfect for yoga, Pilates, and other workouts. 
    Designed for durability and support, they provide excellent cushioning for joints, ensuring a comfortable workout experience.
      </p>
      <br>
    </div>
    ...
    <div class="md:w-1/2">
      <div class="rounded-xl overflow-hidden shadow-lg">
       <img src="{{ asset('images/mat.png') }}" alt="Prime Fit Dumbbell" class="w-full h-auto object-cover">
        ...
        <div class="max-w-4xl mx-auto px-4">
          ...
          <div class="mb-6">
            ...
            <p id="answer-1" class="text-gray-700 mt-2 hidden">
             The best materials are PVC, TPE, natural rubber, and cork. 
             These offer durability, non-slip surfaces, and comfort during practice.
            </p>
          </div>
          ...
          <div class="mb-6">
            <div class="flex items-center justify-between cursor-pointer" onclick="toggleFAQ(2)">
              <h3 class="text-lg font-semibold text-gray-800">
                2. Are yoga mats eco-friendly?
              </h3>
              <span id="icon-2" class="text-xl text-gray-600">+</span>
            </div>
            <p id="answer-2" class="text-gray-700 mt-2 hidden">
             Some mats are made from eco-friendly materials like natural rubber or TPE, 
             which are free from harmful chemicals and biodegradable.
            </p>
          </div>
          ...
          <div class="mb-6">
            <div class="flex items-center justify-between cursor-pointer" onclick="toggleFAQ(3)">
              <h3 class="text-lg font-semibold text-gray-800">
              3.How long will my yoga mat last?
              </h3>
              <span id="icon-3" class="text-xl text-gray-600">+</span>
            </div>
            <p id="answer-3" class="text-gray-700 mt-2 hidden">
           With proper care, a yoga mat can last anywhere from 1-5 years, 
