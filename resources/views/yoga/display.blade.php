            ...
            <tbody class="divide-y divide-gray-700">
                ...
                <tr class="hover:bg-gray-700 transition duration-200">
                    ...
                    <td class="p-4 text-center">
                        <a href="{{ route('yoga.remove', $id) }}" class="inline-flex items-center bg-red-600 hover:bg-red-700 px-4 py-2 rounded-md shadow transition text-white text-sm font-medium">
            ...
            <p class="text-lg font-semibold mb-4">
                ...
                <span class="text-green-400">
                    ${{ number_format(collect($cart)->sum(fn($item) => $item['price'] * $item['quantity']), 2) }}
                              ...
                              <a href="{{ route('yoga.checkout') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2 rounded-md shadow-md transition inline-flex items-center">
